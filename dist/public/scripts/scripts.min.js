...
function slideIn(){$(".js-slide-in").each(function(n,e){isElementInViewport(e)&&$(e).addClass("is-visible")})}function isElementInViewport(n){"function"==typeof jQuery&&n instanceof jQuery&&(n=n[0]);var e=n.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}$(document).ready(function(){$("img").unveil(200),$(window).scroll($.throttle(80,function(){slideIn()}))}),$(window).load(slideIn),$(window).resize(slideIn);
